                ...
                <div class="card-body">
                  <form method="post">
                   <div class="form-group row mb-3">
                    ...
                    <div class="form-group row mb-3">
                        <div class="col-xl-6">
                        <label class="form-control-label">Select Class Subject<span class="text-danger ml-2">*</span></label>
                         <?php
                        ...
                        <div class="col-xl-6">
                        <label class="form-control-label">Select Class Section<span class="text-danger ml-2">*</span></label>
                            <?php
